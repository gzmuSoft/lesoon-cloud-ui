  ...
  data () {
    return {
      ...
      columns: [
        ...
        { key: 'name', title: '名称', editType: 'name' },
        { key: 'spell', title: '全拼', editType: 'spell' },
        { key: 'createTime', title: '创建时间', editType: 'createTime' },
        { key: 'createUser', title: '创建角色', editType: 'createUser' },
        { key: 'modifyTime', title: '修改时间', editType: 'modifyTime' },
        { key: 'modifyUser', title: '修改角色', editType: 'createTime' },
        { key: 'isEnable', title: '是否可用', editType: 'isEnable' },
        { key: 'sort', title: '排序', editType: 'sort' },
        { key: 'remark', title: '备注', editType: 'remark' },
        {
          title: '操作',
          key: 'handle',
          fixed: 'right',
